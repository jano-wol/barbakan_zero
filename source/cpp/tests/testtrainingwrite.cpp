...
void Tests::runTrainingWriteTests() {
  ...
  auto run = [&](
    ...
    cout << "Num captured black stones " << 0 << endl;
    cout << "Num captured white stones " << 0 << endl;
...
.........
...

  {
    ...
    for(int i = 0; i<100; i++) {
      ...
      FinishedGameData* data = gameRunner->runGame(seed, botSpec, botSpec, forkData, NULL, logger, stopConditions, nullptr, nullptr, false, false, 0);
...
.o.......
      ...
      BoardHistory hist(board,P_BLACK,Rules::parseRules("tromp-taylor"));
      testStatuses(board,hist,P_BLACK);
      BoardHistory hist2(board,P_WHITE,Rules::parseRules("tromp-taylor"));
...
.xxox.xx.
      ...
      BoardHistory hist(board,P_WHITE,Rules::parseRules("tromp-taylor"));
      testStatuses(board,hist,P_WHITE);
      BoardHistory hist2(board,P_WHITE,Rules::parseRules("japanese"));
      testStatuses(board,hist2,P_WHITE);
