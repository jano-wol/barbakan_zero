...
vector<SearchParams> Setup::loadParams(
  ...
  for(int i = 0; i<numBots; i++) {
    ...
    if(cfg.contains("surewinDepth"+idxStr)) params.surewinDepth = cfg.getInt("surewinDepth"+idxStr, 0, 63);
    else if(cfg.contains("surewinDepth"))   params.surewinDepth = cfg.getInt("surewinDepth",        0, 63);
